    ...
    <div class="w-100 bg-info text-white fixed-top">
            <div class="d-flex p-1 justify-content-around">
                <div class="d-flex justify-content-start">
                    ...
                    <a title="Moj profil" href="{{route('users.show',['id' => session()->get('user')->id])}}" class="navbar-brand text-white ml-3 mt-1">{{session()->get('user')->first_name }} {{session()->get('user')->last_name}}</a>
                </div>
