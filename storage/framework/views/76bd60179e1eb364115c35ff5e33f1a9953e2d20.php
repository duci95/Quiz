    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                ...
                <form class="form-group" method="POST">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-6" id="firstname-div">
                            ...
                            <input type="text" class="form-control" id="firstname" value="<?php echo e(session()->get('user')->first_name); ?>">
                        </div>
                        <div class="col-6">
                            <label for="lastname" class="col-form-label text-muted">Prezime</label>
                            <input type="text" class="form-control" id="lastname" value="<?php echo e(session()->get('user')->last_name); ?>">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-6">
                            <label for="email" class="col-form-label text-muted text-muted">Email</label>
                            <input type="text" class="form-control" id="email" value="<?php echo e(session()->get('user')->email); ?>">
                        </div>
                        <div class="col-6">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger d" data-id="<?php echo e(session()->get('user')->id); ?>"  >Deaktiviraj nalog</button>
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Odustani</button>
                <button type="button"  data-id="<?php echo e(session()->get('user')->id); ?>" class="btn btn-primary save">Sačuvaj</button>
            </div>
        </div>
    </div>
</div><?php /**PATH D:\New folder\Quiz\resources\views/modals/user-edit.blade.php ENDPATH**/ ?>