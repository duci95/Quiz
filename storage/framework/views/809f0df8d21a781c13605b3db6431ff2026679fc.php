    ...
    <div class="w-100 bg-info text-white fixed-top">
            <div class="d-flex p-1 justify-content-around">
                <div class="d-flex justify-content-start">
                    ...
                    <a title="Moj profil" href="<?php echo e(route('users.show',['id' => session()->get('user')->id])); ?>" class="navbar-brand text-white ml-3 mt-1"><?php echo e(session()->get('user')->first_name); ?> <?php echo e(session()->get('user')->last_name); ?></a>
                </div>
            <span  id="category" data-category="<?php echo e($data->category->id); ?>" class="h2 text-white mt-1 move-left"><?php echo e($data->category->category_name); ?></span>
            <a href="<?php echo e(route('logout')); ?>" class="ml-5 btn btn-outline-dark h5 mt-1 text-center text-white">Odjavi se</a>
        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Dusan\Quiz\resources\views/pages/quiz.blade.php ENDPATH**/ ?>