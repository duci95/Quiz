$(document).on('click','.quiz',function() {
   ...
   $.ajax({
      ...
      success : function(response) {
          bootbox.dialog({
              title: category_name,
              message: `<p>Klikom na <i>Počni test </i>pokreće se test u trajanju od 20 minuta iz kategorije ${category_name} od 10 pitanja, nema negativnih poena, postoji samo jedan tačan odgovor za svako pitanje. <strong>Srećno!!!</strong></p>`,
              buttons: {
                  cancel: {
                      label: "Odustani",
